...
class ProtobufEventSerializerTest {
    ...
    private final ProtobufEventSerializer serializer = new ProtobufEventSerializer();
    ...
    static Event sampleEvent() {
        ...
        return new Event("id-proto", "NORMAL", "ecommerce", "omnistreamforce",
